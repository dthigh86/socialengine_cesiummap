                ...
                <li class="sd-threat-content-right-section">
                    <ul>
                        <li class="sd-threat-comments">
                            <a class='sd-threat-comments-count smoothbox' href="<?php echo $this->url(array('expect_id' => $expect->getIdentity()),'airport_expectprofile',true); ?>"><?php echo $expect->getCommentCount(true); ?></a>
                        </li>
                        <li class="sd-threat-options" id="sd-threat-options">
                            ...
                            <ul style="display:none;" class="sd-threats-options-lists">
                                <li><a class="smoothbox" href="<?php echo $this->url(array('module' => 'core','controller' => 'report','action' => 'create', 'subject' => $expect->getGuid()),'default',true); ?>">Report</a></li>
                                <?php if($expect->getOwner()->getIdentity() == $this->viewer()->getIdentity() || $this->viewer()->isAdmin()): ?>
