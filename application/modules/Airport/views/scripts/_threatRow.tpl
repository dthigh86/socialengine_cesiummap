                ...
                <li class="sd-threat-content-right-section">
                    <ul>
                        <li class="sd-threat-comments">
                            <a class='sd-threat-comments-count smoothbox' href="<?php echo $this->url(array('threat_id' => $threat->getIdentity()),'airport_threatprofile',true); ?>"><?php echo $threat->getCommentCount(true); ?></a>
                        </li>
                        <li class="sd-threat-options" id="sd-user-threat-options">
                            ...
                            <ul style="display:none;" class="sd-threats-options-lists">
                                <li><a class="smoothbox" href="javascript:void(0);">Report</a></li>
                                <?php if($threat->getOwner()->getIdentity() == $this->viewer()->getIdentity() || $this->viewer()->isAdmin()): ?>
