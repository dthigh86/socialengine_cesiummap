...
<div class="sd-pia-section">
    <div class="sd-pia-content">
        ...
        <?php if($this->threats->count() > $this->threats->getCurrentPageNumber()): ?>
            <a href="javascript:void(0);" class="sd_view_more" onclick="loadMoreThreats(this,<?php echo $this->threats->getCurrentPageNumber()+1; ?>);"><?php echo $this->translate("View More"); ?></a>
        <?php endif; ?>
    </div>
</div>
