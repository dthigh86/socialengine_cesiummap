...
<div class="sd-threats-section">
    ...
    <div class="sd-threats-input-section">
        <div id="sd-filter-threat-options" class="sd-filter-options">
            <a href="javascript:void(0);" onclick="sdFilterThreatOptions(this);" class="sd-filter-selected">Aircraft</a>
            <ul class="sd-filter-options-lists" style="display:none;">
                <li><a href="javascript:void(0);" onclick="selectUserThreatOption(this);">All Planes</a></li>
        ...
        <input type="text" class="sd_expect_body" placeholder="Select aircraft type and enter a single specific threat">
...
<div class="sd-pia-section">
    <h3>Accident & Incident History</h3>
                ...
                <li class="sd-pia-listing">
                    <ul class="sd-pia-listing-content">
                        ...
                        <li class="sd-pia-right-section">
                            <a href="<?php echo $threat->href; ?>" target="_blank"><?php echo $threat->title; ?></a>
                        </li>
                    </ul>
                </li>
            <?php endforeach; ?>            
