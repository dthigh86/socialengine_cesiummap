...
@media only screen and (max-width: 800px){
    ...
    .sd-threat-left-section .sd-upvote a:before,
    .sd-threat-left-section .sd-downvote a:before { font-size: 18px; }
    .sd-threats-input-section { padding: 20px 0px 10px; }
    .sd-threats-input-section input { width: 60%; }
    .sd-vote-count { font-size: 14px; width: 50px; }
    .sd-threat-left-section { width: 110px; }
...
@media only screen and (max-width: 680px){
    ...
    .sd-threat-left-section { width: 70px; }
    .sd-expects-filter-section, 
    .sd-threats-filter-section {
        position: static;
        display: block;
...
<div class="sd-threats-section">
    ...
    <div class="sd-threats-input-section">
        <div id="sd-filter-options" class="sd-filter-options">
            <a href="javascript:void(0);" onclick="sdFilterOptions(this);" class="sd-filter-selected">Flight</a>
            <ul class="sd-filter-options-lists" style="display:none;">
                <li class="active"><a href="javascript:void(0);" onclick="selectThreatOption(this);">Flight</a></li>
        ...
        <input type="text" class="sd_expect_body" placeholder="What can you expect? (Data entry bar)">
