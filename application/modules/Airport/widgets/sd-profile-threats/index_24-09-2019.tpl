...
.sd-threats-content a.sd_view_more {
    text-align: center;
    display: block;
    max-width: 100px;
    margin: 5px auto;
...
<div class="sd-threats-section">
    <div class="sd-threats-content">
        ...
        <a href="javascript:void(0);" class="sd_view_more" onclick="loadMoreUserThreats(this,<?php echo $this->paginator->getCurrentPageNumber()+1; ?>);"><?php echo $this->translate("View More"); ?></a>
        <?php endif; ?>
    </div>
</div>
...
function loadMoreUserThreats(element,page){
    ...
    var request = new Request.HTML({
        ...
        onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript) {
            ...
            var content = div.getElement(".layout_airport_sd_profile_threats");
            if(!content){
                return;
            }
