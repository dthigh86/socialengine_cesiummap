...
en4.core.runonce.add(function() {
    var autocompleter = new Autocompleter.Request.JSON('sdquery', en4.core.baseUrl+'airports/suggest', {
        'minLength': 1,
        'delay' : 250,
        'selectMode': 'pick',
...
.layout_airport_header_search #searchform {
    padding: 0;
...
.layout_airport_header_search select#type {
    display: none;
}
