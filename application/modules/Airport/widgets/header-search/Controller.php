...
class Airport_Widget_HeaderSearchController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
      ...
      // Prepare form
      $this->view->form = $form = new Core_Form_Sdsearch();
      ...
      $this->view->sdquery = $query = (string) @$values['sdquery'];
